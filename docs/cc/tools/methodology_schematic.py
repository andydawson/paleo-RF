...
def build_svg():
    ...
    parts.append(f'<text class="t-foot" x="{W - 20}" y="{H - 14}" text-anchor="end">paleo-RF, branch chris-dev · 2026-09-17 · generated by docs/cc/tools/methodology_schematic.py</text>')
    parts.append("</svg>")
    return "\n".join(parts)
