...
**Note.** slide 18: added the recipe recovered from git 383002d as a second figure

## Provenance

- when: 2026-09-23 16:01:58 to 16:02:40 (0.7 min)
- status: completed
- commit: 3ece189 (run-interp)
- working tree: **DIRTY** - scripts/ or R/ had uncommitted changes
- host: beastly | cores used: 0-7
- BLAS/OMP/MKL threads: 8 /  / 
